...
<body class="grey lighten-4">
  ...
  $sql = "SELECT username, groupname2points FROM users WHERE groupname1= '$group' OR groupname2= '$group' OR groupname3= '$group' OR groupname4= '$group'";
  $result = mysqli_query($conn, $sql);
